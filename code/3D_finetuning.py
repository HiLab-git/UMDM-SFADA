...
from dataloaders.dataset import threeDDataSet, TwoStreamBatchSampler
from utils import losses
from utils.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
...
parser.add_argument('--pretrained_path', type=str, default='/path/to/pretrained/source/model', help='Path to the pretrained model')
...
parser.add_argument('--validation_iterations', type=int, default=50,
                    help='Number of labeled data samples')
parser.add_argument('--active_method', type=str, default="random",
