...
from data_augmentation.custom_transforms.scalar_type import RandomScalar
from data_augmentation.transformation_list import (
...
def get_training_transforms(
        ...
        do_dummy_2d_data_aug: bool, do_spatial_transform: bool
    ) -> BasicTransform:
        transforms = []
        ...
        if mirror_axes is not None and len(mirror_axes) > 0 and do_spatial_transform:
